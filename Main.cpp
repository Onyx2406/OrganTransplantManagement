...
addEdge("Mumbai", "Delhi", 2);
addEdge("Mumbai", "Bangalore", 3);
addEdge("Mumbai", "Ahmedabad", 6);
addEdge("Delhi", "Surat", 6);
addEdge("Delhi", "Jaipur", 2);
addEdge("Delhi", "Boston", 6);
addEdge("Delhi", "Bhopal", 3);
addEdge("Jaipur", "Thane", 1);
addEdge("Jaipur", "Patna", 2);
addEdge("Kanpur", "Thane", 1);
addEdge("Kanpur", "Indore", 2);
addEdge("Kanpur", "Vadodara", 3);
addEdge("Kanpur", "Nagpur", 5);
addEdge("Kanpur", "Kolkata", 6);
addEdge("Kanpur", "Pune", 6);
addEdge("Pune", "Surat", 2);
addEdge("Pune", "Agra", 2);
addEdge("Pune", "Patna", 4);
addEdge("Agra", "Patna", 5);
addEdge("Chennai", "Vadodara", 1);
addEdge("Chennai", "Patna", 1);
addEdge("Chennai", "Jaipur", 2);
addEdge("Nagpur", "Agra", 3);
addEdge("Nagpur", "Thane", 3);
addEdge("Nagpur", "Surat", 3);
addEdge("Vadodara", "Nagpur", 1);
addEdge("Vadodara", "Pune", 4);
addEdge("Indore", "Nagpur", 1);
addEdge("Indore", "Bhopal", 1);
addEdge("Bhopal", "Vadodara", 1);
addEdge("Bhopal", "Agra", 2);
addEdge("Bhopal", "Kolkata", 2);
addEdge("Bhopal", "Jaipur", 3);
addEdge("Patna", "Jaipur", 5);
addEdge("Patna", "Surat", 2);
addEdge("Surat", "Patna", 2);
addEdge("Patna", "Thane", 1);
addEdge("Boston", "Nagpur", 1);
}
...
cout << x->name << " : " << organ << " - Blood type " <<
blood_type << " - " << x->location << " - " << x->survivability << "
chance of survival - " << x->time_left << " hours left" << endl;
x = x->next;
}
}
}
...
Patient* PatientTree::addPatient(string name, string organ, string
blood_type, string city, int time_left, int survivability){
bool cityfound = false;
int i = 1*(organ == "heart") + 2*(organ == "lungs") + 3*(organ ==
"liver") + 4*(organ == "pancreas")
+ 5*(organ == "kidney") + 6*(organ == "intestines") + 7*(organ ==
"head");
if(i == 0){
...
int j = 1*(blood_type == "A") + 2*(blood_type == "B") +
3*(blood_type == "AB") + 4*(blood_type == "O");
if(j == 0){
...
Donor* PatientTree::addDonor(string name, string organ, string blood_type,
string city){
bool cityfound = false;
int i = 1*(organ == "heart") + 2*(organ == "lungs") + 3*(organ ==
"liver") + 4*(organ == "pancreas")
...
if(x == NULL){
DonorList[i-1][j-1] = n;
cout << "Added " << n->name << " to spot " << i-1 << "," << j-1
<< endl;
return n;
}
while(x->next != NULL){
...
void PatientTree::enqueue(Pair match){ //we can do this bc we've declared
push in header
...
cout << "Patient: " << arrayQueue[i].patient << " - Donor: " <<
arrayQueue[i].donor << " - Chance of sucessfull operation: "<<
arrayQueue[i].success_rate<< endl;
}
}
...
if(success == true){
cout<<arrayQueue[queueHead].patient<<"'s surgery was a
success."<<endl;
...
Patient* newPatient = myTree.addPatient(name, organ, blood_type,
location, time_left, survivability);
